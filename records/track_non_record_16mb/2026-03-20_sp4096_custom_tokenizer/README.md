...
This is a **non-record submission** — our result (1.2796 BPB on 1×H100)
...
| val_bpb (standard) | **1.2244** | 1.2796 |
| Model size int8+zlib | 15.86 MB | 14.78 MB |
| Under 16MB | ✅ | ✅ |

Our score of 1.2796 does not beat the baseline 1.2244. The gap is primarily
